...
elseif flag == 2
   ...
   % [x,~,P,~,~,qNk2,detNk2,Q2,qlast2] = AEkf2(A_k,f,x,P,h2,z,Q2,R,qNk2,detNk2,N,qlast2,H_k2);
elseif flag == 3
    if (num_z>1)
...
elseif flag == 5
    if (num_z>1)
        ...
        Rj = blkdiag(R,R);
        [x,~,P,~,~,fusionj_qNk,fusionj_detNk,fusionj_Q,fusionj_qlast] = AEkf2(A_k,f,x,P,h,z3,fusionj_Q,Rj,fusionj_qNk,fusionj_detNk,N,fusionj_qlast,H_k);
    end
end